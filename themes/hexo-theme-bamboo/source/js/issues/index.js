          ...
          if (issues && issues.length > 0) {
            ...
            for (j = 0; j < issues.length; j++) {
              ...
              if (issue.screenshot && issue.screenshot.length > 0) {
                imgTag = '<div class="img"><img class="lazy" src="' + issue.screenshot + '" onerror="javascript:this.src=\'https://image.thum.io/get/width/1024/crop/768/' + issue.url + '\';"/></div>';
              } else {
                imgTag = '<div class="img"></div>';
              }
              let infoTag = '<div class="info">';
              if (issue.avatar && issue.avatar.length > 0) {
                infoTag += '<img class="lazy" src="' + issue.avatar + '" onerror="javascript:this.src=\'https://image.thum.io/get/width/1024/crop/768/' + issue.url + '\';"/>';
              }
