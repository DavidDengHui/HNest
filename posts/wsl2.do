...
<div class="post-detail-header" id="thumbnail_canvas" style="background-repeat: no-repeat; background-size: cover; 
  background-position: center center;position: relative;background-image:url('https://img2.covear.top/2023-05-29-20230529205922.png')">
...
<li>为了尽可能干净（您可能仍在运行实际上比已安装版本更旧的进程），重新启动您的 WSL 发行版。打开一个 CMD 或者 Powershell 窗口，并终止您的 WSL 实例。假设您的实例名为fedoraremix，您可以关闭实例为<code>wsl -t fedoraremix</code>，然后使用<code>wsl -d fedoraremix</code>重新启动。</li>
  ...
  <ul class="post-copyright">
    ...
    <strong>文章链接:  </strong>
    <a href="/posts/wsl2.do" target="_blank" title="Windows 最佳拍档 Fedora Remix for WSL2">https://hnest.eu.org/posts/wsl2.do</a>
    </li>
...
<div class="post-nav">
  ...
  <div class="post-nav-prev post-nav-item">
    <div class="post-nav-img" style="background-size: cover; 
      ...
      <img class="lazyload lazyload placeholder" src="https://img2.covear.top/2023-05-29-20230529211752.png" class="lazyload placeholder" data-srcset="https://img2.covear.top/2023-05-29-20230529211752.png" srcset="/img/loading.min.svg" alt="">
    </div>
...
PC上偷渡黑苹果向来比较费事儿，说起来还是虚拟机好使，可以非常方便地体验到macOS系统，app store里面的软件
  ...
  <div class="post-nav-next post-nav-item">
    <div class="post-nav-img" style="background-size: cover; 
      background-position: center center;">
      <img class="lazyload lazyload placeholder" src="https://img2.covear.top/2023-05-29-20230529205207.png" class="lazyload placeholder" data-srcset="https://img2.covear.top/2023-05-29-20230529205207.png" srcset="/img/loading.min.svg" src="" alt="">
    </div>
